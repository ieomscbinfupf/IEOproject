...
(http://dee2.io) pipeline by @ziemann19, and further packaged into a
[SummarizedExperiment](https://bioconductor.org/SummarizedExperiment)
...
kable(DEgenesTab[1:10, ], "html", escape=FALSE, row.names=TRUE, 
